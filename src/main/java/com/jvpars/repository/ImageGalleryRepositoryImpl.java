...
public class ImageGalleryRepositoryImpl implements ImageGalleryRepositoryCustom {
    ...
    public Page<ImageGallery> findAll(GlobalSearch globalSearch, Pageable pageable) {
        ...
        Criteria criteria = session.createCriteria(ImageGallery.class);
        ...
        return new PageImpl<ImageGallery>(criteria.list(), pageable, totalFound);
    }
